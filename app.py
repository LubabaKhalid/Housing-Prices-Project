...
# Define the path to your background image relative to your Streamlit app file
background_html = """
<style>
body {
...
with col2:
    ...
    st.write("<h4 style='font-size: 20px; font-weight: bold;'>Mean Price by Number of Bedrooms</h4>", unsafe_allow_html=True)
    st.write(df.groupby('bedrooms')['price'].mean())

# Continue with the rest of the code for visualizations, model evaluation, etc.
